 ...
 */
final class Version20260811121141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paie ADD masse_salariale DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paie DROP masse_salariale');
